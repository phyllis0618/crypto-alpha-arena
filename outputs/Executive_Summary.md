...
_Disclaimer: This document is generated from **synthetic Monte Carlo-style simulations** for internal roadmap planning. It is **not** investment advice, a forecast of Yanfu performance, or a solicitation. Replace simulations with audited historical data before board / LP use._

## Headline

- **Simulated sleeve Sharpe (post US/HK beta overlay):** CN CSI1000 ≈ -0.38; US SPX ≈ -0.92; SEA average ≈ -0.75; Crypto ETF sleeve ≈ 0.56.
- **Crypto booster experiment:** Sortino moves from **-1.14** (core global blend) to **-1.38** with ~4.5% dynamic ETF sleeve + CN trend gate.
- **Diversification:** Cross-sleeve correlation matrix shows **modest linkage** between CN hedge basket and US/SEA sleeves — suitable for a multi-asset platform targeting **~$5.0B** of capacity once infrastructure, licensing, and investor mandates align.
...
## 36-Month Roadmap Mapping

### Phase 1 (0–12m) — HK SFC Type 9 & cross-border plumbing
...
### Phase 2 (12–36m) — US mid-to-low frequency index enhancement at scale
...
### Phase 3 (36m+) — Global platform — SEA + compliant crypto satellites
...
- Placeholder: `clinical_trial_success_probability` for US biotech sleeves — integrate proprietary NLP + structured trial databases.
